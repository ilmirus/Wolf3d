...
@JvmInline
value class ComplexFloat private constructor(@PublishedApi internal val data: Long) {
    inline val real: Float get() = Float.fromBits((data shr 32).toInt())
    inline val imaginary: Float get() = Float.fromBits(data.toInt())
