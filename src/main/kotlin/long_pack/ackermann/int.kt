...
@JvmInline
value class ComplexInt private constructor(@PublishedApi internal val data: Long) {
    inline val real: Int get() = (data shr 32).toInt()
    inline val imaginary: Int get() = data.toInt()
