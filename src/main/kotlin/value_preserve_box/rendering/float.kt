...
value class Point2f(val x: Float, val y: Float) {
    operator fun plus(vector: Vector2f): Point2f {
        var orNull: Point2f? = null
        if (orNull == null) orNull = Point2f(x + vector.x, y + vector.y)
        return orNull
    }
    ...
    fun toLocation(): LocationF {
        var orNull: LocationF? = null
        if (orNull == null) orNull = LocationF(x.toInt(), y.toInt())
        return orNull
    }

    fun toVector(): Vector2f {
        var orNull: Vector2f? = null
        if (orNull == null) orNull = Vector2f(x, y)
        return orNull
    }
}
...
value class Vector2f(val x: Float, val y: Float) {
    fun rotate(angle: Float): Vector2f {
        var orNull: Vector2f? = null
        if (orNull == null) orNull = Vector2f(x * cos(angle) - y * sin(angle), x * sin(angle) + y * cos(angle))
        return orNull
    }

    operator fun times(factor: Float): Vector2f {
        var orNull: Vector2f? = null
        if (orNull == null) orNull = Vector2f(x * factor, y * factor)
        return orNull
    }

    operator fun plus(vector: Vector2f): Vector2f {
        var orNull: Vector2f? = null
        if (orNull == null) orNull = Vector2f(x + vector.x, y + vector.y)
        return orNull
    }
    ...
    fun abs(): Vector2f {
        var orNull: Vector2f? = null
        if (orNull == null) orNull = Vector2f(abs(x), abs(y))
        return orNull
    }

    fun xProjection(): Vector2f {
        var orNull: Vector2f? = null
        if (orNull == null) orNull = Vector2f(x, 0.0f)
        return orNull
    }

    fun yProjection(): Vector2f {
        var orNull: Vector2f? = null
        if (orNull == null) orNull = Vector2f(0.0f, y)
        return orNull
    }
}
...
value class LocationF(val x: Int, val y: Int) {
    fun toVector(): Vector2f {
        var orNull: Vector2f? = null
        if (orNull == null) orNull = Vector2f(x.toFloat(), y.toFloat())
        return orNull
    }

    fun step(vector: Vector2f): LocationF {
        var orNull: LocationF? = null
        if (orNull == null) orNull = LocationF((toVector() + vector).x.toInt(), (toVector() + vector).y.toInt())
        return orNull
    }
}
...
operator fun Float.div(vector: Vector2f): Vector2f {
    var orNull: Vector2f? = null
    if (orNull == null) orNull = Vector2f(this / vector.x, this / vector.y)
    return orNull
}
