...
class MyPanelF : JPanel(), KeyListener, MouseListener, Benchmarkable {
    ...
    private fun drawScene(g: AbstractGraphics) {
        ...
        for (x in 0 until screenWidth) {
            ...
            val rayDir =
                dir.plus(plane.times(cameraX, wrapper).decodeVector2f(wrapper), wrapper).decodeVector2f(wrapper)
            ...
            if (rayDir.x < 0) {
                ...
                sideDist = (pos.toVector(wrapper).decodeVector2f(wrapper)
                    .minus(mapLocation.toVector(wrapper).decodeVector2f(wrapper), wrapper)
                    .decodeVector2f(wrapper)).xProjection(wrapper).decodeVector2f(wrapper)
                    .times(deltaDist.x, wrapper).decodeVector2f(wrapper)
            } else {
                step = Vector2f(1.toFloat(), 0.0f)
                sideDist = (mapLocation.toVector(wrapper).decodeVector2f(wrapper).plus(Vector2f(1.0f, 0.0f), wrapper)
                    .decodeVector2f(wrapper)
                    .minus(pos.toVector(wrapper).decodeVector2f(wrapper), wrapper).decodeVector2f(wrapper)).xProjection(
                        wrapper
                    ).decodeVector2f(wrapper)
                    .times(deltaDist.x, wrapper).decodeVector2f(wrapper)
            }
            if (rayDir.y < 0) {
                ...
                sideDist = sideDist.plus(
                    (pos.toVector(wrapper).decodeVector2f(wrapper)
                        .minus(mapLocation.toVector(wrapper).decodeVector2f(wrapper), wrapper)
                        .decodeVector2f(wrapper)).yProjection(wrapper).decodeVector2f(wrapper)
                        .times(deltaDist.y, wrapper).decodeVector2f(wrapper), wrapper
                ).decodeVector2f(wrapper)
            } else {
                step = step.plus(Vector2f(0.0f, 1.toFloat()), wrapper).decodeVector2f(wrapper)
                sideDist = sideDist.plus(
                    (mapLocation.toVector(wrapper).decodeVector2f(wrapper).plus(Vector2f(0.0f, 1.0f), wrapper)
                        .decodeVector2f(wrapper)
                        .minus(pos.toVector(wrapper).decodeVector2f(wrapper), wrapper)
                        .decodeVector2f(wrapper)).yProjection(wrapper).decodeVector2f(wrapper)
                        .times(deltaDist.y, wrapper).decodeVector2f(wrapper), wrapper
                ).decodeVector2f(wrapper)
            }
            ...
            while (hit == 0) {
                ...
                if (sideDist.x < sideDist.y) {
                    sideDist = sideDist.plus(deltaDist.xProjection(wrapper).decodeVector2f(wrapper), wrapper)
                        .decodeVector2f(wrapper)
                    mapLocation = mapLocation.step(step.xProjection(wrapper).decodeVector2f(wrapper), wrapper)
                        .decodeLocationF(wrapper)
                    side = 0
                } else {
                    sideDist = sideDist.plus(deltaDist.yProjection(wrapper).decodeVector2f(wrapper), wrapper)
                        .decodeVector2f(wrapper)
                    mapLocation = mapLocation.step(step.yProjection(wrapper).decodeVector2f(wrapper), wrapper)
                        .decodeLocationF(wrapper)
                    side = 1
                }
